...
async function testPolaris2Indexing() {
  console.log("=========================================================");
  console.log("🔎 TESTING OPSPILOT AI v4 — POLARIS2 GITHUB REPO INDEXING TEST");
  console.log("=========================================================\n");

  const email = `polaris2-tester-${Date.now()}@opspilot.ai`;
  const password = "password123";
  const orgName = "Polaris2 Org";
  const projectName = "Polaris2 Project";
  const repoName = "Polaris2";
  const gitUrl = "https://github.com/jitendrac9610/Polaris2.git";
  ...
  try {
    ...
    console.log("\n=========================================================");
    console.log("🎉 POLARIS2 REPOSITORY CLONING AND INDEXING PASSED!");
    console.log("=========================================================");
...
testPolaris2Indexing().then(() => process.exit(0));
